        ...
        if (config !== null) {
            ...
            if (locales[name] != null) {
                ...
                if (locales[config.parentLocale] != null) {
                    ...
                    // treat as if there is no base_admin config
...
module.exports = function() {
	...
	//Occupy the global variable of Chart, and create a simple base_admin class
	...
	function pushOrConcat(base, toPush) {
		if (toPush) {
			if (helpers.isArray(toPush)) {
				//base_admin = base_admin.concat(toPush);
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.elements.line = {
		...
		fill: true // do we fill in the area between the line and its base_admin axis
	};
...
module.exports = function(Chart) {
	...
	var LinearScale = Chart.LinearScaleBase.extend({
		determineDataLimits: function() {
			...
			// Common base_admin implementation to handle ticks.min, ticks.max, ticks.beginAtZero
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		...
		buildTicks: function() {
			...
			me.scaleSizeInUnits = 0; // How large the scale is in the base_admin unit (seconds, minutes, etc)
