...
require("./routes/admin/categories")(router_admin);
require("./routes/admin/cities")(router_admin);
require("./routes/admin/dashboard")(router_admin);
require("./routes/admin/events")(router_admin);
require("./routes/admin/directories")(router_admin);
